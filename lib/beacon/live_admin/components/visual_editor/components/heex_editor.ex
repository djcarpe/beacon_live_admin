defmodule Beacon.LiveAdmin.VisualEditor.Components.HEExEditor do
  ...
  def render(assigns) do
    ...
    <div id={@id} class="flex">
      ...
      <.live_component module={Beacon.LiveAdmin.VisualEditor.PropertiesSidebarComponent} id="properties-sidebar" site={@site} ast={@ast} selected_element_path={@selected_element_path} heex_editor={@myself} />
    </div>
    """
  end

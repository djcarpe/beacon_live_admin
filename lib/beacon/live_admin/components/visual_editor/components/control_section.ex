defmodule Beacon.LiveAdmin.VisualEditor.Components.ControlSection do
  ...
  def render(assigns) do
    ~H"""
    <section class="px-3 py-4 border-b border-b-base-300 border-solid group" id={@id} phx-hook="ControlSectionSaveExpandedState" data-section-id={@id}>
      <div class="mb-2 flex items-center justify-between">
        <div class="flex items-center gap-2">
          <button :if={@label} type="button" class="text-base-content/50" phx-click="toggle" phx-target={@myself}>

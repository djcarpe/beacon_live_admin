      ...
      <.live_component module={ControlSection} id={@id <> "-section"} label="Layout">
        <form phx-change="update_layout" phx-target={@myself} class="space-y-4">
          <div class="grid grid-cols-2 items-center gap-x-2">
            ...
            <select name="display" class="w-full py-0.5 px-2 bg-base-200 border-base-300 rounded-md leading-5 text-sm">
              <option value=""></option>
          ...
          <%= if @is_flex? do %>
            <div class="grid grid-cols-2 items-center gap-x-2">
              ...
              <select name="flex_direction" class="w-full py-0.5 px-2 bg-base-200 border-base-300 rounded-md leading-5 text-sm">
                <option value=""></option>
            ...
            <div class="grid grid-cols-2 items-center gap-x-2">
              ...
              <select name="flex_wrap" class="w-full py-0.5 px-2 bg-base-200 border-base-300 rounded-md leading-5 text-sm">
                <option value=""></option>
            ...
            <div class="grid grid-cols-2 items-center gap-x-2">
              ...
              <select name="align_items" class="w-full py-0.5 px-2 bg-base-200 border-base-300 rounded-md leading-5 text-sm">
                <option value=""></option>
            ...
            <div class="grid grid-cols-2 items-center gap-x-2">
              ...
              <select name="justify_content" class="w-full py-0.5 px-2 bg-base-200 border-base-300 rounded-md leading-5 text-sm">
                <option value=""></option>
            ...
            <div class="grid grid-cols-2 items-center gap-x-2">
              ...
              <select name="align_content" class="w-full py-0.5 px-2 bg-base-200 border-base-300 rounded-md leading-5 text-sm">
                <option value=""></option>
